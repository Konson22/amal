...
import standingChildrenImage from '../../assets/images/young-boys.jpeg'
import refugeeChildrenImage from '../../assets/images/annie-spratt-cVEOh_JJmEE-unsplash.jpg'
    ...
    <>
      ...
      <div className="bg-orange lg:flex items-center text-white lg:px-[10%] px-2 lg:py-[7rem] py-16">
        <div className="flex-1 lg:mb-0 mb-4 relative">
          <img className='lg:h-[410px] h-[250px] lg:rotate-[2deg] border-4 border-amber-300' 
            src={childrenImage} 
            alt='' 
          />
          <img className='lg:block hidden lg:h-[200px] w-[300px] rotate-[-12deg] border-4 border-amber-300 absolute top-[260px] right-[-70px]' 
            src={standingChildrenImage} alt='' 
          />
          <img className='lg:block hidden lg:h-[150px] w-[200px] rotate-[-12deg] border-4 border-amber-300 absolute top-[260px] left-[-70px]' 
            src={refugeeChildrenImage} alt='' 
          />
        </div>
