...
import { FaRegComments, FaHeartbeat } from "react-icons/fa"

export default function Blog() {
  return (
    <div className="flex lg:px-[8%] px-3 lg:py-[2rem] py-[1.3rem]">
      <div className="flex-1">
        <h3 className="text-2xl mb-4">Stories from refugees</h3>
        <div className="">
          {posts.map(post => <PostCard post={post} />)}
        </div>
      </div>
      <div className="lg:block hidden w-[35%]"></div>
    </div>
  )
}
